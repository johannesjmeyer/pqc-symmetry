...
/usr/bin/time -f "\t%E real,\t%M kb MaxMem" python3 -u run_ttt.py -s true -n $steps -p $points -l tcemoid -f output/depth_7 -ss 0.008 -sr true -re $depth -ep true -epn $epochs