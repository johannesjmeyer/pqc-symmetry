...
from ansatz_lib import makecircXYZ_RY,makecircXYZ, makecircXXX, makecirc_TFIM, makecirc_TFIM_RY, makecirc_TFIM_RYdiff  
from hamiltonian_lib import hamTTT,hamTFIM,hamXXX
...
namesym=E
if(namesym=="sym"):
    ansatznow=makecircXXX
else:
    ansatznow=makecircXYZ_RY #makecircXYZ
hamnow=hamXXX #hamTTT
...
#
namefile=f"XXX_{namesym}_{optname}_iter{maxiter}_P{Pmin}_L{Lmin}_r{A}"
#End INPUT__

# output file
outfileOpt = f"temp_results_XXX/file_Opt"+namefile+".npz"
