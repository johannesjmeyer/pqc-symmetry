...
#SBATCH --job-name=BPsymTFIM       # Job name, will show up in squeue outputi
...
python main_BP_PQC_TFIM.py $nrands ${Linp[$SLURM_ARRAY_TASK_ID]} ${Arrp[$SLURM_ARRAY_TASK_ID]} $ans 
