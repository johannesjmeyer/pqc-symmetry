...
from ansatz_lib import makecircXYZ, makecircXYZ_RY
...
def ansatz(P,L):
    if(ans=="sym"):
        return makecircXYZ(P,L)
    else:
        return makecircXYZ_RY(P,L) 


Ht_BP = termZZ(0,1,L)
##### 1) BP Random points
# output file
outfile_BP_rand = f"temp_results_XXX/fileBP_XXX_rand_L={L}_P={P}_{ans}.npz"
